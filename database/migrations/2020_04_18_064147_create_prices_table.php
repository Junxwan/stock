...
class CreatePricesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('prices', function (Blueprint $table) {
            ...
            $table->decimal('foreign_investment_shareholding', 5)->comment('外資持股(%)');
            $table->decimal('trust_shareholding', 5)->comment('投信持股(%)');
            $table->decimal('self_employed_shareholding', 5)->comment('自營商持股(%)');
